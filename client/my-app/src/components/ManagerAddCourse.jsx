...
const ManagerAddCourse = (props) => {
    ...
    const [usernameSpeeker, setUsernameSpeeker] = useState("");
    ...
    useEffect(() => {
        checkCreateButtonState();
    }, [name, usernameSpeeker, information, videoTriler, backgroundImage]);
                ...
                <div className="dialog-container">
                    ...
                    <div className="input-group">
                        ...
                        <InputText
                            ...
                            className="input-field"
                            // onChange={handleInputChange}
                            value={usernameSpeeker}
                            onChange={(e) => setUsernameSpeeker(e.target.value)} // Update state on input change
                        />
                    </div>
                    <div className="input-group">
