...
const ManagerSetResponds = () => {
    ...
    // Render component
    return (
        <div style={{ padding: "20px", backgroundColor: "rgba(252, 237, 253, 0.3)" }}>
            {loadData ? (
                <div style={{ textAlign: "center" }}>
                    <p>Loading...</p>
                </div>
                ...
                <div style={{ textAlign: "center" }}>
                    <p style={{ fontSize: "25px", fontWeight: "bold", color: "#888" }}>
                      ! אין תגובות 
                    </p>
                </div>
            ) : (
                            ...
                            <div style={{ display: "flex", gap: "10px", marginTop: "10px" }}>
                                {editingRespondId === respond._id ? (
                                    <>
                                        <Button
                                            label="שמור"
                                            style={{
                                                backgroundColor:"#9575cd",//rgba(179, 157, 219, 0.8)",//"#673ab7", // סגול בהיר
                                                color: "white",
                                                border: "none",
                                                borderRadius: "5px",
                                                fontWeight: "bold",
                                        ...
                                        <Button
                                            label="בטל"
                                            style={{
                                                backgroundColor: "#e91e63", // ורוד בהיר
                                                color: "white",
                                                border: "none",
                                                borderRadius: "5px",
                                                fontWeight: "bold",
                                    ...
                                    <Button
                                        label="ערוך"
                                        style={{
                                            backgroundColor: "#2196f3",//"#ce93d8", // לילך בהיר
                                            color: "white",
                                            border: "none",
                                            borderRadius: "5px",
                                            fontWeight: "bold",
                                ...
                                {respond.introduce ? (
                                    <Button
                                        label="לא להציג"
                                        style={{
                                            backgroundColor: "#ffab40",///"#ffab91", // כתום בהיר
                                            color: "white",
                                            border: "none",
                                            borderRadius: "5px",
                                            fontWeight: "bold",
                                    ...
                                    <Button
                                        label="להציג"
                                        style={{
                                            backgroundColor: "#4caf50", // תכלת בהיר
                                            color: "white",
                                            border: "none",
                                            borderRadius: "5px",
                                            fontWeight: "bold",
